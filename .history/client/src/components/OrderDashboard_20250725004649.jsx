    ...
    try {
      ...
      if (response.ok) {
        ...
        result.data.forEach((order) => {
          const randomDistanceKm = 0.5 + Math.random() * 1.5;
                ...
                >
                  <div className="card-body p-6">
                    ...
                    <div className="mt-5 space-y-3 text-sm text-gray-300">
                      ...
                      >
                        {openMapId === order._id && (
                          <MapContainer center={coords} zoom={15} style={{ height: '300px' }}>
                            <TileLayer
                            ...
                            <Marker position={extras.marker} icon={markerIcon}>
                              <Popup>
                                <div>
                                  <p><strong>Delivery Person:</strong> {extras.deliveryPerson}</p>
                                  <p><strong>ETA:</strong> {extras.eta} mins</p>
                                </div>
                              </Popup>
                            </Marker>
                            <Polyline
                              positions={[coords, extras.marker]}
                              color="blue"
                              weight={4}
                            />
                          </MapContainer>
                        )}
                        <div className="cursor-pointer mt-3 text-blue-500 text-sm">
                          {openMapId === order._id ? 'Hide Map' : 'Track Delivery'}
                        </div>
                      </div>
                    </div>
                  </div>
