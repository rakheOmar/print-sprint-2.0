    ...
    <div className="min-h-screen bg-gray-950 p-6 text-gray-100 font-sans relative">
      ...
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10"> {/* Wider gap */}
        ...
        <div className="bg-gray-800 shadow-2xl rounded-xl p-8 flex flex-col gap-5 self-start sticky lg:top-6 border border-blue-700"> {/* Sticky, more padding, border */}
          ...
          <div className="mt-6">
            <label className="label text-base font-medium text-gray-300 mb-2"> {/* Larger label */}
              Payment Method
            </label>
            <select
            ...
            >
              {/* THIS IS THE KEY CHANGE for text visibility inside dropdown options */}
              <option value="cash" className="text-gray-200 bg-gray-700">Cash on Delivery</option>
              <option value="online" className="text-gray-200 bg-gray-700">Online Payment</option>
            </select>

            {orderPlaced ? (
              <div className="bg-green-700 text-green-100 p-4 rounded-lg flex items-center justify-center gap-3 text-lg font-semibold shadow-md animate-fade-in"> {/* Enhanced success message */}
