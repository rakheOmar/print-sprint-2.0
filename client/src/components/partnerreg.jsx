...
function PartnerReg() {
  ...
  const handleRegistration = async (e) => {
    ...
    formData.append("role", "partner"); // ✅ Set role to partner
      ...
      <div className="flex justify-center items-center min-h-screen bg-base-200">
        <div className="card w-full max-w-md bg-base-100 shadow-lg p-6">
          ...
          <p className="text-center mb-2">
            Welcome, <strong>{newlyRegisteredUser.fullname}</strong>! Your
    ...
    <div className="flex justify-center items-center min-h-screen bg-base-200">
      <div className="card w-full max-w-2xl bg-base-100 shadow-xl p-8 space-y-6">
        <h2 className="text-2xl font-bold text-primary text-center">
          Become a PrintSprint Partner
        </h2>
        <p className="text-sm text-gray-500 text-center">
          Pick your location on the map and register to get started.
        </p>
