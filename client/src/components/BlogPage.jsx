...
import { Rss, CalendarDays, Tag, ArrowRight } from 'lucide-react';
...
const blogPosts = [
  {
    ...
    date: "July 20, 2025",
    category: "Innovation",
    imageUrl: "https://images.unsplash.com/photo-1510519138101-570d1dca3d6b?auto=format&fit=crop&q=80&w=2940",
    link: "#"
  },
  {
    id: 2,
    ...
    imageUrl: "https://images.unsplash.com/photo-1522204523234-87295a756ce7?auto=format&fit=crop&q=80&w=2940",
    link: "#"
  },
  {
    id: 3,
    ...
    date: "July 10, 2025",
    category: "Security",
    imageUrl: "https://images.unsplash.com/photo-1542831371-d6682701832d?auto=format&fit=crop&q=80&w=2940",
    link: "#"
  },
  {
    id: 4,
    ...
    imageUrl: "https://images.unsplash.com/photo-1534723821867-b5b974574971?auto=format&fit=crop&q=80&w=2940",
    link: "#"
  }
];
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {blogPosts.map((post, index) => (
            <div
              key={post.id}
              className={`bg-gray-800 rounded-xl shadow-lg border border-gray-700 overflow-hidden flex flex-col transform hover:scale-[1.02] transition-all duration-300 animate-fade-in-up ${delayClasses[index]}`}
            >
              <img src={post.imageUrl} alt={post.title} className="w-full h-48 object-cover" />
              <div className="p-6 flex flex-col flex-grow">
                <h2 className="text-2xl font-bold text-white mb-3 text-left">{post.title}</h2>
                <p className="text-gray-300 text-sm leading-relaxed mb-4 flex-grow text-left">{post.excerpt}</p>
                ...
                <a href={post.link} className="mt-6 flex items-center justify-between text-orange-400 hover:text-orange-300 font-semibold transition-colors duration-200">
